...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function P = PNN(MS, PAN, sensor_model, nBits, NDxI_flag)

if nargin == 4, NDxI_flag = true; end
...
if NDxI_flag
    if Nb==8, Nb = Nb+4; else Nb = Nb+2; end
end
...
%%
disp(sprintf('------>  [PNN]: Prediction time = %0.4gs', Test_time));
